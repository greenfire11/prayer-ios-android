...
import 'package:ios_prayer/calendar_screen.dart';
import 'package:ios_prayer/calendar_screen2.dart';
import 'package:ios_prayer/main.dart';
                ...
                Container(
                  child: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => CalendarScreen2(lat: double.parse(widget.lat), lng: double.parse(widget.lng),),),
                );
                    },
                  ),
                ),
